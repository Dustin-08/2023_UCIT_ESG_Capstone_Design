    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deviceListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (selectedDevice != null) {
                    ...
                    // 예: 연결 시도, 데이터 통신 등
                    Toast.makeText(MainActivity.this, "디바이스가 선택되었습니다: " + deviceName, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivity.this, "디바이스를 찾을 수 없습니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btn_bluetooth_onoff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleBluetooth();
                Toast.makeText(MainActivity.this, "ON/OFF 버튼 클릭" , Toast.LENGTH_SHORT).show();
            }
            ...
            private void toggleBluetooth() {
                ...
                if (bluetoothAdapter.isEnabled()) {
                    ...
                    if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.BLUETOOTH_ADMIN}, REQUEST_PERMISSION_BLUETOOTH_ADMIN);
                    } else {
                        // 권한이 이미 부여되어 있는 경우
                        bluetoothAdapter.disable();
                        Toast.makeText(MainActivity.this, "블루투스가 비활성화되었습니다", Toast.LENGTH_SHORT).show();
                        btn_bluetooth_onoff.setVisibility(View.INVISIBLE); // On/Off 버튼을 invisible로 설정
                    }
                } else {
                    // 블루투스가 비활성화된 경우
                    Toast.makeText(MainActivity.this, "블루투스가 활성화되어있지 않습니다", Toast.LENGTH_SHORT).show();
                    // 블루투스 상태 변경 권한 요청
                    ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.BLUETOOTH_ADMIN}, REQUEST_PERMISSION_BLUETOOTH_ADMIN);
                }
